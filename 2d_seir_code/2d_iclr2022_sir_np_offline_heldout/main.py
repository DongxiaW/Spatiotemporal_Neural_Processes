...
for seed in range(3): #3
    ...
    opt = torch.optim.Adam(dcrnn.parameters(), 2e-3) #1e-3

    x_train,y_train = x_all, y_all

    train_losses, val_losses, test_losses, z_mu, z_logvar = train(30000,x_train,y_train,x_val, y_val, x_test, y_test,1500, 3000) #20000, 5000
    ...
    mae_testset.append(test_mae.item())
